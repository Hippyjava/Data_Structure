...
public class FindLongestString {
    ...
    public static void main(String[] args) {
        ...
        /*
         * EXPECTED OUTPUT: ---------------- Test case 1: Longest string: banana Test
         * case 2: Longest string: hippopotamus Test case 3: Longest string: universe
         * Test case 4: Longest string: javascript Test case 5: Longest string: aaa
         */
